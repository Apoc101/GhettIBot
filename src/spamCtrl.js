...
function spam() {
    return new Promise((resolve, reject) => {
        ...
        if (!spamChannel)
            reject('In che minchia di canale vuoi spammare?!?!?!?!');

        // send message on spam channel
        spamChannel.send('AO DIO CANE')
        .then(msg => {
            ...
            setTimeout(() => {
                ...
                // otherwise, just resolve promise to end this looping
                    ...
                    resolve();
                    spamChannel.send('ok ma sei un po coglione');
                }
            }, 100)
        })
        .catch(console.log);
...
// public functions that will be used in your index.js file  (module exports is an xd moment)
module.exports = {
