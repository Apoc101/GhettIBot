...
Bot made by Gabriel aka Gibgab with <3
        ...
        if(CMD_NAME === 'baz' || CMD_NAME === 'bazorpa'){ //this command requires admin and to be in the gamers' server (https://discord.gg/nJQvwGb32g), if you're not it catches the error
